...
typedef GenScatterHierarchy<TYPELIST_3(int, string, Widget),
				Holder>
	WidgetInfo;
...
//	TypeAt<SignedIntegrals, 2> a = 4;
//	cout << a << endl;
	
	cout << IndexOf<SignedIntegrals, long>::value << endl;
	cout << IndexOf<SignedIntegrals, short>::value << endl;
	cout << IndexOf<SignedIntegrals, signed char>::value << endl;
	cout << IndexOf<SignedIntegrals, int>::value << endl;
	cout << IndexOf<SignedIntegrals, unsigned int>::value << endl;

	cout << Length<SignedTypes>::value << endl;
	
	typedef typename Erase<SignedTypes, double>::Result TestType;

	cout << Length<TestType>::value << endl;
